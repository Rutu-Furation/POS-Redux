...
export const ADD_TABLE_LOADING = "tablelist/loading";
export const ADD_TABLE_ERROR = "tablelist/error";
export const ADD_TABLE_SUCCESS = "tablelist/success";

export const UPDATE_TABLE_LOADING = "tablelist/loading";
export const UPDATE_TABLE_ERROR = "tablelist/error";
export const UPDATE_TABLE_SUCCESS = "tablelist/success";
